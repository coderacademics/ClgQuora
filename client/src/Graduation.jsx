    ...
    return (
        <div className="slide3" id="graduation">
            ...
            <div className="container" style={{ display: "flex" }}>
                <div className="pic">
                    <img src={hat} height="300px" width={"350px"} />
                </div>
                <div className="msg_slide3">
                    <h1 className="grad">Graduation</h1>
                    <p className="msg">You may leave SCC.But SCC will never leave you. All the memories you have made, all the experiences you have gained and most importantly the friends you have made will stay with you forever in your life. Best of luck for the next phase of your life.</p>
                </div>
            </div>
